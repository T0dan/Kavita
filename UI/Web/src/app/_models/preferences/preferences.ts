...
export const layoutModes = [{text: 'single', value: LayoutMode.Single}, {text: 'double', value: LayoutMode.Double}, {text: 'double-manga', value: LayoutMode.DoubleReversed}, {text: 'double-manga-first-non-wide-single', value: LayoutMode.DoubleReversedFirstSingle}, {text: 'double-manga-no-cover', value: LayoutMode.DoubleReversedNoCover}]; // , {text: 'Double (No Cover)', value: LayoutMode.DoubleNoCover}
